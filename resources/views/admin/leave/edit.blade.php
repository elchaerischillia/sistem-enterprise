...
<div class="container">
    ...
    <form action="{{ route('leave.update', $leave->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="date" name="start_of_date" id="start_of_date" class="form-control" value="{{ optional($leave->start_of_date)->format('Y-m-d') }}" required>
        </div>

        <div class="form-group">
            <label for="end_of_date">End Date</label>
            <input type="date" name="end_of_date" id="end_of_date" class="form-control" value="{{ optional($leave->end_of_date)->format('Y-m-d') }}" required>
        </div>
